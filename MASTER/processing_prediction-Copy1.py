...
s_nhead = 2
dropout = 0.2
gate_input_start_index = 175 #158
gate_input_end_index = 236 #221
...
factor_folder = Path(factor_path)  # 使用不同的变量名
factor_files = [file.name for file in factor_folder.glob("*self_exp*.pkl")]  # 存储到新变量

test_process_info = pd.DataFrame([])
for filename in factor_files:  # 改为 factor_files
    # 更安全的文件名解析方式
...
# # def main(
# #     # workflow_path = f"/home/a/anaconda3/Master/data/workflow_config_master_Alpha158_csi800.yaml",
# #     workflow_path = f'/workflow_config_master_Alpha158.yaml',
# #     # Data_path = f'/home/a/anaconda3/Master/data/results/master_20250904_csi800_20120101_20250901_pkl'
# #     Data_path = f'data/self_exp/opensource'
# # ):
