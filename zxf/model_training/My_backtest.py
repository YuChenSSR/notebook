...
class Backtest:
    ...
    def run(self):
        ...
        # self._account_details.to_csv(f'./account_details_{self._top_k}_{self._n_drop}_{self._hold_p}.csv', index=False, date_format='%Y-%m-%d',float_format='%.3f')
...
def main():
    backtest = Backtest(
        ...
        take_profit_ratio=1,
        market_name="csi800",
        printing_info=True,        pred_filename="/home/idc2/notebook/zxf/data/modoel_training/csi800_20251211_20150101_20251208/Predictions/master_predictions_backday_8_csi800_12_1160_1e-05_0.4_54.csv",
