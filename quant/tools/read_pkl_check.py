...
def read_data(data_dir):
    with open(f'{data_dir}/csi1000_self_dl_valid.pkl', 'rb') as f:
...
def data_check(dl_train):
    ...
    print("=== 每列统计 ===")
    result_s = result[result['zero_ratio'] >= 0.1]
    
    
    print(result_s.to_string(max_cols=None))
    print(len(result_s))
    print(len(result))
...
def main(
    data_dir: str = "/home/a/notebook/zxf/data/Daily_data/Training_data/csi1000",

    # notebook/zxf/data/Daily_data/Training_data/csi1000/csi1000_self_dl_valid.pkl
):
