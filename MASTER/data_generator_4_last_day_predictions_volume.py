...
def parse_args():
    ...
    parser.add_argument("--universe", type=str, default="csi800", help="universe type: csi800, csi1000, or default")
...
if __name__ == "__main__":
    ...
    train_data_dir = f'data/daily_predict'
